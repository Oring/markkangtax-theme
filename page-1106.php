...
?>
  ...
  <section class="topSection container">
		<div class="topTitleWrap">
			...
			<p class="topDesc">
				해외 금융 계좌 신고인 FBAR를 들어보셨나요? 미국의 영주권/시민권자라면 전 세계 어디에 살고 있더라도 IRS에 미국 세금 보고 및 해외 금융 계좌를 신고해야 합니다. 또한 미국에 머무는 날이 많아서 183일 테스트를 통과하면, 자동으로 해외에 있는 금융 계좌를 신고해야 하는 의무가 생깁니다. 
			</p>
			<p class="topDesc">
				한국 및 해외계좌의 모든 잔액합이 1년 중에 단 하루라도 1만 달러 이상을 보유한 적이 있다면, 미 재무부에 매년 4월 15일까지 모든 계좌를 다 신고해야 합니다.
		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<section class="guidePart" id="section2">
					...
					<p class="desc noPad -top">
						FBAR 신고 대상인 금융 계좌들은 위와 같습니다. 간단하게 정리하면 미국 외에 있는 금융기관에 등록된 금융 계좌가 보고 대상입니다. ​예를 들어, 한국 신한은행의 미국 지점에 있는 계좌는 보고 대상이 아니며, 반대로 한국에 있는 씨티은행 계좌는 보고를 해야 합니다. FBAR 신고서에는 각 계좌 정보와 연중 최고 잔액 및 해당 금융 기관의 정보를 기재해야 합니다.
					</p>
					<h4 class="guideSubTitle">
						계좌 최고 잔액 조건
					</h4>
					<p class="desc noPad -top">
						...
						현재 환율을 적용하면 약 1200만 원인데 한국에서 경제활동을 하시는 분들 거의 대부분이 FBAR 신고 대상이 됩니다.
					</p>
				</section>
				<!-- /섹션2 -->
				...
				<section class="guidePart">
					...
					<ul class="guideDescList noPad -top">
						...
						<li>
							고의로 잘못 신고했을 경우, 1) 최고 $100,000와 위반 계좌 잔액의 50% 중에서 큰 금액의 벌금이 부과되거나, 2) 형사상 최대 $100,000벌금이나 징역 5년, 또는 3) 벌금과 징역 5년 모두.
						</li>
					</ul>
					<p class="desc">
					...
					<p class="desc noPad -top">
						IRS는 기존에 우편으로 접수했던 FBAR를 2013년부터 의무적으로 인터넷으로 신고하도록 바꿨습니다. 또한 한국과는 2016년 한미 계좌 정보 자동 교환을 시작하여, 한국 금융 계좌 정보가 매년 미국으로 보내지고 있습니다. ​
						이 두 가지로써 IRS에서는 한국에 있는 납세자의 금융 계좌 정보와 신고 내용을 자동으로 비교할 수 있는 시스템을 이미 갖추고 있습니다. ​
						이를 바탕으로 점점 벌금을 부과하며 신고 제도를 강화해나가고 있습니다.
					</p>
					<p class="desc">
	​					 우리 한인들도 벌금이 부과된 사례가 뉴스에 보도되기도 했는데요. ​2016년 코네티컷 주의 김 모 씨에게는 징역 6개월과 고의성 벌금 1400만 불을 부과하였고, 2018년 뉴욕 주에 살고 있는 한인 동포 남모 씨에게 한국에 있는 은행 계좌 2개를 2년 동안 미신고 한 것에 대해 연도별로 1만 불씩 벌금을 부과하였습니다.
					</p>
				</section>
				<!-- /섹션3-1 -->
