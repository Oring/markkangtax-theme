...
function optionsframework_options() {
  ...
  $allowedtags = true;
	...
	$options[] = array(
		'name' => __('카카오톡 ID', 'options_check'),
		'id' => 'contact_kakao',
		'class' => 'mini',
		'type' => 'text');

	$options[] = array(
		'name' => __('Contact E-mail', 'options_check'),
		'desc' => __('연락 가능한 이메일', 'options_check'),
		'id' => 'contact_email',
		'type' => 'text');

	$options[] = array(
		'name' => __('법인명', 'options_check'),
		'id' => 'company_name',
		'class' => 'mini',
		'type' => 'text');

	$options[] = array(
		'name' => __('대표자 성명', 'options_check'),
		'id' => 'company_representative',
		'class' => 'mini',
		'type' => 'text');

	$options[] = array(
		'name' => __('사무실 전화번호', 'options_check'),
		'id' => 'office_number',
		'class' => 'mini',
        'type' => 'text');
        
    $options[] = array(
        'name' => __('사무실 전화번호(KR)', 'options_check'),
        'id' => 'office_number_kr',
        'class' => 'mini',
        'type' => 'text');

	$options[] = array(
		'name' => __('사무실 주소', 'options_check'),
		'id' => 'office_address',
		'type' => 'text');

	$options[] = array(
		'name' => __('사업자등록번호', 'options_check'),
	...
	$options[] = array(
		'name' => __('메인 상담 폼 On/Off', 'options_check'),
		'desc' => __('메인페이지 상담 폼 켜기/끄기', 'options_check'),
		'id' => 'main_contact_on_off',
		'std' => '1',
		'type' => 'radio',
		'options' => $on_off);
	...
	$options[] = array(
		'name' => '후기',
		'desc' => '후기 컨텐츠를 Shortcode 형식에 맞게 작성해주세요.', // [ims_sliders autoplay="interval 속도" mousewheel="휠 swipe 여부(yes/no)" speed="swipe 속도" class="클래스" arrows="화살표 유무(yes/auto/no)" pages="페이지 네비 유무(yes/auto/no)" desc="디스크립션 유무(no/yes)"] [ims_slider src="이미지 주소" title="타이틀" alt="Alt 태그" desc="디스크립션"]
		'id' => 'review_slider',
		'type' => 'editor',
