		...
		<div class="row">
			...
			<div class="col-sm-9">
				...
				<section class="guidePart" id="section1">
					...
					<p class="desc">
						미국 세금 보고 대상자를 "US Taxable Resident"라고 합니다. 기준은 시민권, 영주권자 뿐만 아니라 183일 거주 테스트(Substantial Presence Test)를 만족한 분들도 세법상 거주자(Resident Alien)로서 미국 세금 보고의 의무가 발생합니다. 183일 거주 테스트는 다음 두가지를 동시에 만족해야합니다. 첫째, 세금 보고 연도에 31일 이상 미국에 체류해야하며, 둘째, 세금 보고 연도를 포함한 최근 3년간의 미국 체류일수가 183일을 초과해야 합니다. 
						183일 계산법은 아래와 같습니다.
					</p>
					<div class="greyBox">
						<p class="greyBoxText">
					...
					<p class="desc">
						세법상 거주자와 달리 세법상 비거주자는 미국에서 발생한 소득만 보고를 하고, 세금 보고 양식(1040NR)이 다르며, 해외금융계좌 등의 보고 의무가 없습니다.
					</p>


					<h4 class="guideSubTitle strong-red">
						한국에서 살고 있고, 한국 국세청에 이미 소득세를 내고 있는데, 미국국세청(IRS)에도 이중으로 소득세를 내야 하나요?
					</h4>
					<p class="desc noPad -top">
						네, 한국에 소득세를 납부했더라도 미국에 세금보고를 해야합니다.
						한국에서 발생한 소득이 미국 세법에 따라 세금이 다시 계산되고, 각종 소득 공제 및 세액 공제를 적용하고 남는 차액이 있다면 세금을 내셔야할 수도 있습니다. 대다수의 분들은 각종 공제 혜택을 통해서 세금액이 없습니다. 
						하지만 이런 공제 혜택을 적용 받아서 세금이 없다는 것을 보고해야 합니다. 이 보고를 하지 않으면, 공제가 적용되지 않아 납부하지 않아도 되는 세금을 내셔야 할 수도 있습니다. 
					</p>
				</section>
				<!-- /섹션1 -->
				...
				<section class="guidePart" id="section2">
					...
					<p class="desc">
						미국 세법은 한국과 달리, 가족 관계의 여건에 따라 다섯가지 신고 유형으로 분류됩니다. 그리고 신고 유형마다 표준 공제 금액(Standard Deduction)에 차이가 있으며, 매년 물가 변동에 따라 표준 공제 금액은 달라질 수 있습니다.  일반적으로 이 표준 공제 금액보다 총소득 금액이 크다면 세금 보고 대상으로 보시면 됩니다. 하지만 부부개별 신고의 경우, 소득이 $5 이상이면 세금 보고의 의무가 발생합니다. (세금 보고는 일반적으로 소득이 <a href="https://www.irs.gov/" style="text-decoration: underline">IRS</a>가 제시한 표준공제금액(Standard Deduction)보다 많으면 의무적으로 해야합니다. 매년 물가 변동에 따라 표준공제금액이 다르며, 나이와 세금 보고 유형별로 그 금액에 차이가 있습니다.)
					</p>
					<p class="desc">
						이 밖에도 미국에서 자영업 소득이 $400 이상이라면 세금 보고를 해야하며, 본인이 부양 가족(Dependent)으로서 다른 사람의 세금 보고서에 보고 되는데 $1,100 이상의 소득이 있는 경우에도 세금 보고의 의무가 있습니다.
					...
					<p class="desc noPad -top">
						과세연도 마지막 날 12월31일 기준, 법적으로 미혼인 사람이 해당됩니다.
					</p>
					<h4 class="guideSubTitle">
						세대주 신고(Head of Household Filing Status)
					</h4>
					<p class="desc noPad -top">
						미혼(싱글)이신 경우, 부양 가족의 생활비를 절반 이상 지원하면서 6개월 이상 함께 산다면, 세대주 신고로 보고할 수 있습니다.<br>
					...
					<p class="desc noPad -top">
						12월31일 기준으로 기혼인 부부가 특별한 이유로 따로 세금 보고를 할 때 선택하는 신고 유형입니다. 한국에 계시는 분들 중에 배우자가 미국 납세자가 아니며, 미국 시민권/영주권 자녀가 없다면 부부개별로 세금보고를 하시면 됩니다. 부부개별보고의 경우, 소득이 $5 이상이면 세금보고의 의무가 있습니다.
					</p>
					<h4 class="guideSubTitle">
						미망인 신고(Qualifying Widow/er with Dependent Child Filing Status)
					</h4>
					<p class="desc noPad -top">
						배우자 사망 이후, 자녀와 함께 산다면 2년까지 미망인 신고 유형으로 세금 보고를 할 수 있습니다. 미망인 신고는 부부합산 신고와 동일한 세율과 세제 혜택이 있습니다. F, J, M, Q 비자 등으로 미국에 체류중인 유학생이라면 햇수로 5년 동안, 그리고 인턴, 연구원이나 방문교수 등 J, Q 비자 소지자라면 햇수로 2년간 세법상 비거주자(Nonresident Alien)로 보고할 수 있습니다.
					</p>
				</section>
				<!-- /섹션2 -->
					...
					<section class="iconsWrap">
						...
						<ul class="row infoList">
							...
							<li class="col-sm-12 infoItem">
								...
								<span>
									양식 4868을 제출하여 연장신청을 하면 <br class="hdMB">
									10월15일까지 세금보고 기한 연장
								</span>
							</li>
						</ul>
				...
				<section class="guidePart" id="section4">
					...
					<p class="desc noPad -top">
						매달 받으시는 월급등의 소득액 월급 등의 소득액을 1040에 보고합니다.
					</p>
					...
					<p class="desc noPad -top">
						사업이나 프리랜서에서 발생한 소득 및 비용 내역을 Schedule C에 보고합니다. 이 때 사회보장세(Social Security tax)와 의료보험세(Medicare tax)의 명분으로 자영업 세금(Self-Employment Tax)을 내야하는데 이 세금은 자영업 소득의 15.3% 입니다.
					</p>
					<div class="greyBox -dense">
						<p class="greyBoxText">
							•	필요 서류: <br class="hdPC">
					...
					<p class="desc">
						이에 비해 단기양도소득은 위의 일반 세율표(Income tax brackets)를 따르는데, 싱글신고 기준, $9,700 이하일 때 10%의 세율이, $510,301 이상이면 37%까지 올라갑니다. 
					...
					<p class="desc noPad -top">						
						세금 보고 양식에는 각각 번호가 붙여져있는데, 가장 기본적인 개인 세금보고 양식은 1040입니다. 비거주자는 양식 1040NR, 잘못된 보고를 수정할 때는 양식1040X 에 작성합니다. 
				...
				<section class="markAdviceWrap" id="section5">
					...
					<p class="desc">
						고객분들 중에 수정 보고를 의뢰하시는 경우가 있는데, 이미 세금 납부가 완료 되었을지라도 수정 보고를 통해 세금을 최대한 많이 공제를 받기 위함입니다. 그리고 수정 보고를 통해 적게는 몇 천불부터 많게는 몇 만불까지 환급을 받으신 분들도 계셨습니다.  미국에서는 납세자가 세제 혜택에 대한 정보를 제대로 알고 있는지에 따라 혜택을 얼마나 받을 수 있을지 결정됩니다. 따라서 대다수의 미국인들이 좋은 회계사에게 세금 보고를 맡겨서 최대한의 세제 혜택을 받는 것이 절약하는 방법이라고 여깁니다. 
					</p>
				...
				<section class="guidePart">
					...
					<p class="desc">
						...
						그 중에서 조정 전 소득 공제는 다른 말로 우선 공제라 하여, 총소득금(Gross income)에서 가장 먼저 몇 가지 항목에 대해 공제 받을 수 있습니다. 우선 공제 항목은 다음 6가지입니다.
					</p>
					<h4 class="guideSubTitle">
						교육자의 비용:
					</h4>
					...
					<p class="desc noPad -top">
						개인 은퇴연금 (Traditional IRA) 계좌에 납입한 금액을 공제받을 수 있습니다. 납입금 전액을 공제받는 것이 아니라 계좌 종류에 따라 다른 공제 한도액이 있습니다. 1년에 $6,000까지, 50세 이상일 때는 $7,000까지 공제 받을 수 있습니다.
					</p>
					<h4 class="guideSubTitle">
						이사 비용:
					</h4>
					<p class="desc noPad -top">
						이사 비용은 본래 새 직장 때문에 이사를 해야하는 경우 1년 이내에 하되, 전 주거지와 전 직장 사이의 거리가 새 주거지와 새 직장 간의 거리보다 50마일 이상이 되어야 하는 조건이 있었습니다. 하지만 트럼프 세제 개혁으로 2018년부터는 이사비용 공제 대상이 US군인들로 제한되었습니다.
					</p>
					<h4 class="guideSubTitle">
					...
					<p class="desc noPad -top">
						학자금 대출에서 발생한 이자 납부금을 공제 받을 수 있는데, 최대 $2,500까지 공제받을 수 있습니다.
					</p>
					<h4 class="guideSubTitle">
						영업세:
					</h4>
					...
					<p class="desc">
						이렇게 조정 전 소득 공제를 통해 줄어든 소득금액을 조정 후 총소득(Adjusted Gross Income, AGI)이라고 합니다. 조정 후 총소득에서 추가로 소득 공제를 한번 더 적용받을 수 있는데요, 표준공제(Standard deduction)나 항목별 공제(Itemized deduction) 중 한가지를 선택하여 과세 대상 소득을 줄일 수 있습니다. 
					</p>
					...
					<p class="desc">
						납세자는 세금 신고 유형에 따라 표준 공제액을 적용해 과세 대상 소득을 줄일 수 있습니다. 표준공제는 세금 신고 유형에 따라 공제액이 다릅니다. 표준공제 금액은 매년 조금씩 변동이 되며, 아래의 표(회계연도 2020년 기준)와 같이 싱글/부부개별 신고는 $12,550, 부부합산/미망인 신고는 $25,100, 세대주 신고는 $18,800 입니다. 
					</p>
					<div class="tableWrap">
						<table class="sectionTable">
							<thead>
					...
					<p class="desc">
						항목별 공제는 표준공제와 동시 사용할 수 없습니다. 두 가지 중에서 본인에게 유리한 공제를 선택하시면 됩니다. 항목별 공제에는 여러가지가 있으며 그 중 대표적인 몇개 항목을 안내드립니다.
					</p>
					<h4 class="guideSubTitle">
						의료비 공제:
					</h4>
					...
					<p class="desc noPad -top">
						주택 융자에서 발생한 은행 이자를 공제 받을 수 있습니다.
					</p>
					<h4 class="guideSubTitle">
						납부 세금 공제:
					</h4>
					<p class="desc noPad -top">
						주정부, 로컬 정부 등에 낸 세금을 $10,000까지 공제받을 수 있고, 한국에 낸 세금도 인정이 되지만 그럴 경우에는 해외세액 공제/해외 근로소득 공제를 받을 수 없어 주로 사용하지는 않습니다.
					</p>
					<h4 class="guideSubTitle">
						기부금 공제:
					</h4>
				...
				<section class="guidePart">
					...
					<p class="desc">
						세금 공제에는 환급 받을 수 있는 것(Refundable Tax Credit)과 환급 불가능한 것(Nonrefundable Tax Credit) 두가지가 있습니다. 환급 받을 수 있는 세금 공제는 납부할 세금을 $0으로 줄인 뒤에도 남은 금액을 환급받을 수 있습니다. 반면에 환급 불가능한 세금 공제는 세금을 $0으로 만들어줄 뿐, 공제하고 남은 금액은 그대로 소멸되거나 다음 연도로 이월(carry over)이 됩니다. 
					</p>
					<h4 class="guideSubTitle">
						자녀 세금 크레딧(Child Tax Credit) 
					</h4>
					<p class="desc noPad -top">
						자녀 세금 크레딧은 17세 미만의 자녀 면 당 최대 $2,000을 공제 받을 수 있습니다. 모든 자녀가 해당되는 것이 아니라 사회보장번호(Social Security Number)가 있는 미국 시민권/영주권자나 세법상 거주자이어야 합니다.
					</p>
					<p class="desc">
					...
					<p class="desc noPad -top">
						근로소득 세금 크레딧은 저소득 근로자를 위한 세제 혜택이며 환급이 가능합니다. 근로소득이 있어야 신청할 수 있으며, 부부개별 신고와 세법상 비거주자, 투자소득이 $3,650(회계연도 2020년 기준) 이상이면 적용이 불가능합니다. 그리고 소득 및 일정 조건을 갖춘 부양가족의 숫자에 따라 공제금액에 차이가 있습니다.
					</p>
					<p class="desc">
						아래표는 부양가족 자녀수에 따라서 근로소득 세금 크레딧을 받을 수있는 조정 후 총소득(AGI) 한도입니다.  회계연도 2020년 기준, 최대 크레딧은 세 자녀 이상일 때 $6,660, 두 자녀일 때 $5,920, 한 자녀일 때 $538 입니다. 하지만, 이 세금 공제는 아쉽게도 해외에 거주하고 계신 분들은 받을 수 없습니다.
					</p>
					<div class="tableWrap">
						<table class="sectionTable">
							<thead>
					...
					<p class="desc noPad -top">
						한 자녀 당 첫 4년간의 대학 교육비를 공제 받을 수 있습니다. 대학교 이상의 고등 교육 기관의 학비, 교재비 등의 교육 비용에 대해서 첫 $2,000에 대한 100% 금액과 추가 $2,000의 25%인 $500까지 세금 공제를 받을 수 있습니다.
					</p>
					<p class="desc">
					...
					<p class="desc noPad -top">
						13세 미만의 어린 자녀나 케어가 필요한 부양가족을 위해 유치원, 보육 시설 등에 발생한 경비를 공제받을 수 있습니다. 단, 납세자와 배우자 양쪽 다 소득이 있어야하고 또는 한쪽은 구직활동을 하고 있어야 합니다. 부부 중 한쪽이 5개월 이상 풀타임 학생인 경우에도 가능합니다.
					</p>
					<p class="desc">
						크레딧에 적용할 수 있는 보육 비용은 한 자녀 $3,000까지, 두명 이상은 $6,000까지 제한이 있고, 소득의 정도에 따라서 보육 비용의 20%에서 35%까지만 공제를 받을 수 있습니다. 환급은 불가능한 크레딧입니다.
					</p>
					<h4 class="guideSubTitle">
						평생 교육 크레딧(Lifetime Learning Credit)
					</h4>
					<p class="desc noPad -top">
						평생 교육 크레딧은 미국 기회 크레딧과 비슷한 교육비 공제 혜택이 있는데, 제한없이 평생 사용할 수 있고, 교육 비용의 $10,000까지 20%를 공제받을 수 있습니다. 또한 학위 과정에만 제한된 미국 기회 크레딧과는 달리 좀 더 폭이 넓으며 한 코스만 수업을 들어도 신청할 수 있고, 환급은 되지 않습니다.
					</p>
					<p class="desc">
						기회 크레딧과 중복 사용할 수는 없으며 회계연도 2020년 기준, 수정 조정 소득액이 싱글 신고자는 $69,000 이상 부부합산 신고자는 $138,000 이상이면 신청할 수 없습니다.
						또한 싱글 신고자의 수정 조정 소득액이 $59,000-$69,000 범위에, 부부합산 신고는 $118,000-$138,000 사이에 있으면 비율에 따른 삭감된 크레딧을 받게됩니다.
				...
				<section class="guidePart">
					...
					<p class="desc">
						미국 세금 보고시, 한국에 내신 세금을 미국에 또 내야하는 것은 아닙니다. 한미 이중과세 방지협정에 의해 해외세액 공제(Foreign Tax Credit)와 해외근로소득 공제(Foreign Earned Income Exclusion), 해외 거주지 공제(Foreign Housing Exclusion) 등의 항목을 통해 소득액을 공제받을 수 있습니다. 이런 공제를 제대로 알고 적용하면 대부분의 경우 미국에 납부할 세금이 없으며, 어떤 분들은 오히려 환급을 받으시기도 합니다.
					</p>
					<h4 class="guideSubTitle">
						해외근로소득 공제(Foreign Earned Income Exclusion)
					</h4>
					<p class="desc noPad -top">
						해외에서 발생한 근로소득이나 자영업 소득을 회계연도 2020년 기준으로 $107,600 까지 공제받을 수 있습니다.  양식 2555에 작성하며, 자격 조건을 살펴보면 주 거주지(Tax Home)가 해외이거나 연속된 12개월 중에 총 330일 이상 해외에 체류했을 경우입니다.  또한 해외근로소득 공제는 보통 연봉이 1억3천만원 이하인 분들에게 유리합니다. 물론 나머지 두가지 해외 공제들을 적용하여 세금액을 비교해 본인에게 맞는 것을 선택해야합니다.
					</p>
					<p class="desc">
						해외근로소득 공제는 한 소득에 대해서 아래 소개할 해외 세액 공제 (Foreign Tax Credit)와 같이 사용할 수 없습니다. 그리고 한번 적용을 하면 매년 이어지고, 중간에 쓰지 않으면 자동으로 취소한 것으로 간주되며, 한번 취소하면 5년 동안 불가능합니다. 따라서 매년 앞으로 예상되는 수입까지 잘 고려하여 신중하게 생각하고, 제대로 보고하는 것이 중요합니다.
					</p>
					<h4 class="guideSubTitle">
						해외 거주지 공제(Foreign Housing Exclusion)
					</h4>
					<p class="desc noPad -top">
						해외근로소득 공제를 적용하고 남은 금액이 있다면, 다행히도 해외 거주지 공제를 통해 공제를 받을 수 있습니다.
					</p>
					<p class="desc">
						거주지 공제는 여러분이 한국에서 거주하시며 발생한 주거 비용에 대해 공제를 받는 것으로써 렌트비, 수리비, 공과금, 보험료 등의 발생한 비용이 일정 금액을 넘으면 적용할 수 있습니다. 이것을 기본 비용이라고 하며, 해외근로소득 공제금액의 최대값(회계연도 2020년 기준 $107,600)의 16%인 $17,216을 초과하는 만큼 공제를 받고, 한도액은 30%인 $32,280입니다.
					</p>
					<p class="desc">
						한도액은 지역마다 차이가 있는데, 서울을 예로 하면 2020년 기준으로 $53,800까지 거주지 비용으로 신청할 수 있으며, 여기에서 기본비용인 $17,216을 뺀 $36,584 만큼 해외 거주지 공제를 받을 수 있게 됩니다.
					</p>
					<h4 class="guideSubTitle">
						해외 세액 공제(Foreign Tax Credit)
					</h4>
					<p class="desc noPad -top">
						해외에 납부한 세금을 크레딧으로 공제해주는 것입니다. 한국에 납부한 근로소득세, 이자/배당금 소득세, 임대소득세, 양도소득세 등 각종 소득세를 양식 1116에 작성하여 보고합니다.
					</p>
					<p class="desc">
						이 때 한국의 납부세액 보다 미국세금이 더 많아서 공제를 적용하고 남은 금액은 전년도 해외납부세액으로 소급되어 공제받을 수 있습니다. 만약 소급하고도 공제되지 못한 금액은 10년에 걸쳐 이월하여 해외 세액 공제를 받을 수 있습니다.					</p>
					<p class="desc">
						해외 납부 세금을 항목별 공제에 적용할 수도 있지만, 세금 공제가 아닌 소득 공제이기 때문에 공제금액이 그다지 크지 않아 대부분이 해외세액공제를 사용합니다.
					</p>
				</section>
				<!-- /섹션7 -->
				...
				<section class="markAdviceWrap" id="section6">
					...
					<p class="desc">
						소득 이외에도 해외에 보유하고 있는 자산, 외국인으로부터 받은 증여/상속, 해외에 소유하고 있는 법인 등의 정보를 미국에 보고해야하는 의무가 있습니다. 이는 세금을 징수하기 위함이 아닌, 해외로 자산 은닉 및 탈세를 방지하기 위한 것으로 미국이 FATCA 를 통하여 한국을 포함한 전세계 국가들과 금융 정보를 교류하고 있기 때문에 점점 강화되고 있습니다. 특히, 이런 보고는 과세에 영향을 주지 않는 보지만, 불이행 시 벌금이 크게 부과되니 각별히 신경쓰셔서 보고해야 합니다. 아래에 설명드릴 해외 정보 보고에는 각각 다양한 경우가 있으나 꼭 아셔야 할 대표적인 것들만 다루고자 합니다.
					</p>
				</section>
				<!-- 마크 코멘트 -->
