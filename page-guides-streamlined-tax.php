<?php get_header(); ?>
  ...
  <section class="topSection container">
		<div class="topTitleWrap">
			...
			<p class="topDesc">
				미국 영주권자/시민권자 혹은 세법상 거주자라면, 비록 미국에 살고 있지 않더라도 해외 소득과 해외 자산을 매년 4월15일까지 미 국세청(IRS)에  보고해야 하는 의무가 있습니다. 그러나 이 의무에 대해 몰라서 그동안 보고를 하지 못했던 분들이 한국을 포함하여 전세계에 많이 계십니다. 
			</p>
			<p class="topDesc">
				그래서 미 국세청IRS에서는 해외자산 자진신고 간소화 절차(Streamlined Filing Compliance Procedures, SFCP)라는 제도를 만들었습니다. IRS에 관련된 서류들을 잘 정리하여 제출하시면, 그 동안의 누락된 신고들을 한번에 처리하실 수 있는 구제 제도입니다. 그러면 이 제도와 관련해 좀 더 자세히 알아보도록 하겠습니다.
			</p>
	</section>
	<!-- /INTRO 섹션 -->
			...
			<div class="col-sm-9">
				...
				<section class="guidePart" id="section1">
					...
					<p class="desc">
						...
						해외 자산의 기준은 은행 계좌뿐 아니라 보험, 증권, 펀딩, 연금, 투자계좌 등을 포함하고 있어 누락될 우려가 아주 높은 편입니다.
						만약 해외 금융 계좌 보고가 누락되었다면 건당 최고 13,000불에서 계좌 잔고의 50%까지 패널티가 부과될 수 있습니다. 
					</p>
					<h4 class="guideSubTitle">
						패널티 피해 사례 #1
					</h4>
					<p class="desc noPad -top">
						롱아일랜드에 거주하는 한인 남 모씨는 한국의 금융계좌 2곳에 예치했던 200여만 달러를 미 금융당국에 신고하지 않았습니다.  
						지난 2009년 2개의 금융기관 잔고가 46만에 달했지만, 2010년 6월 30일까지 이를 연방재무부에 신고하지 않아 1만 4,813달러의 벌금을 부과받았습니다. 
						또 2010년에도 잔고가 151만원에 달했지만 2011년 6월 30일까지 이를 신고하지 않아 벌금 2만 달러를 부과받았습니다.
					</p>
					<h4 class="guideSubTitle">
						패널티 피해 사례 #2
					</h4>
					<p class="desc noPad -top">
						Moore씨는 스위스 계좌에 30만불 이상의 금액을 가지고 있었는데 이에 관해 해외 금융 계좌 보고 및 해외 소득 보고를 2009년까지 하지 않았습니다. 
					...
					<p class="desc">
						그래서 그 동안 잘 몰라서 보고를 못하셨다면, 지금부터라도 꼭 전문가와 상의를 통해 SFCP를 서둘러 준비하시는 것이 좋습니다. 
						왜냐하면 얼마전 미 국세청IRS에서 SFCP는 영구적인 제도가 아닌, 얼마든지 때가 되면 소멸될수 있다고 공식 발표한 바가 있었기 때문입니다. 
						이 뜻은 지금 해외 금융 계좌 자진 신고 간소화 절차가 시행되고 있을 때, 가능한한 서둘러서 사면을 받으라는 뜻입니다. 
						미국에 계시는 미 시민권자/영주권자 뿐 아니라, 한국이나 다른 해외에 계시는 미 시민권자/영주권자 분들도 이 문제를 가능한한 빨리 해결하시길 바랍니다.
					</p>
				</section>
				<!-- /섹션1 -->
				...
				<section class="guidePart" id="section2">
					...
					<p class="desc noPad -top">
						만약, 해외거주자의 조건을 만족한다면, 특별한 벌금이 없이, 그동안의 밀린 이자를 납부하는 정도로, 모든 패널티들을 완전히 사면받을수 있습니다. 
					</p>
					<div class="greyBox -dense">
						<p class="greyBoxText">
							해외 거주자의 조건:<br>
							최근 3년중 1년을 330일 이상 해외에 체류했을 경우 가능.<br>
					...
					<p class="desc noPad -top">
						미국 내 거주자의 경우, 지난 6년간의 연도별 연말기준잔액의 합중 가장 높은 금액의 5%를 벌금으로 납부하여야, 사면이 가능합니다.
				...
				<section class="markAdviceWrap">
					...
					<p class="desc">
						얼마전 미국세청(IRS)에서, 이 해외자산 자진신고 간소화절차(SFCP)는 영구적인 제도가 아닌, 얼마든지 소멸될수 있는 제도라고 공식 발표한 바가 있습니다. 
						이것은 지금 이 제도가 살아 있을때, 가능한한 서둘러서, 간소화 절차를 통해 사면을 받으라는 뜻입니다. 
						그래서 저 또한 많은 고객분들과의 상담을 통해, 그동안 잘 몰라서 FBAR/FATCA 보고를 하지 못했던 분들은, 
						더 늦기전에 이 해외자산 자진신고(SFCP)를 미루지 마시고 지금 할수 있을때 하시라고 적극 권장해드리고 있습니다. 
